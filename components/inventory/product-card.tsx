      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div>
            ...
            <p className={`font-medium text-xs ${daysUntilExpiry <= 7 ? "text-orange-400" : ""}`}>
        ...
        {(product.temperature !== undefined || product.humidity !== undefined) && (
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div>
            ...
            <p className="font-medium text-green-400">${product.sellingPrice.toFixed(2)}</p>
          </div>
        </div>
        ...
        <div className="space-y-2 text-sm">
          ...
          <div>
            ...
            <p className="font-medium font-mono text-xs">{product.batchNumber}</p>
          </div>
        </div>
        ...
        {product.halalCertified && (
          <div className="p-2 rounded bg-green-500/10 border border-green-500/20">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="font-medium">{new Date(product.certificationExpiry).toLocaleDateString()}</span>
            </div>
          </div>
        )}
