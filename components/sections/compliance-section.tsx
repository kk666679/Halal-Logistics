  ...
  const auditFeatures = [
    {
      ...
      description: "Complete blockchain-verified audit trails for regulatory compliance",
    },
    {
      icon: <BarChart3 className="h-6 w-6 text-indigo-500" />,
      title: "Real-time Dashboards",
      description: "Live compliance monitoring with customizable reporting dashboards",
    },
    {
      icon: <AlertCircle className="h-6 w-6 text-amber-500" />,
      title: "Compliance Alerts",
      description: "Proactive notifications for certification renewals and compliance issues",
    },
    {
      icon: <Users className="h-6 w-6 text-purple-500" />,
      title: "Multi-stakeholder Access",
      description: "Secure access for auditors, regulators, and certification bodies",
    },
  ]

  return (
    <section id="compliance" className="relative w-full py-12 md:py-24 lg:py-32 bg-muted/30 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <ScrollReveal>
            <Card className="glassmorphic-card mb-12">
              <CardHeader>
                <CardTitle className="text-2xl tracking-tight">Compliance Overview</CardTitle>
                <CardDescription>Real-time compliance metrics across your supply chain</CardDescription>
              </CardHeader>
              <CardContent>
