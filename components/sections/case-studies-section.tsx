...
export function CaseStudiesSection() {
  const caseStudies = [
    {
      ...
      location: "Malaysia",
      challenge: "Manual certification tracking leading to compliance delays and export rejections",
      solution: "Implemented blockchain-based certification tracking with AI-powered validation",
      results: [
    ...
    },
    {
      ...
      location: "UAE",
      challenge: "Temperature excursions during transportation causing product spoilage",
      solution: "Deployed IoT sensors with real-time monitoring and AI route optimization",
      results: [
    ...
    },
    {
      ...
      location: "Australia",
      challenge: "Complex supply chain traceability requirements for international markets",
      solution: "Integrated multi-stakeholder platform with end-to-end supply chain visibility",
      results: [
  ...
  const stats = [
    { value: "500+", label: "Businesses Served", icon: <Building2 className="h-5 w-5" /> },
    { value: "15+", label: "Countries", icon: <Globe className="h-5 w-5" /> },
    { value: "99.9%", label: "Uptime", icon: <TrendingUp className="h-5 w-5" /> },
    { value: "50K+", label: "Certifications Processed", icon: <Users className="h-5 w-5" /> }
  ]

  const testimonials = [
    {
      quote: "The platform transformed our certification process. What used to take weeks now takes hours.",
      author: "Ahmad Rahman",
      position: "Operations Director",
      company: "Al-Barakah Foods"
    },
    {
      quote: "Real-time monitoring has eliminated our temperature excursion issues completely.",
  ...
  return (
    <section id="case-studies" className="relative w-full py-12 md:py-24 lg:py-32 bg-muted/30 overflow-hidden">
              ...
              <motion.div whileHover={{ y: -5 }} transition={{ type: "spring", stiffness: 300 }}>
                <Card className="glassmorphic-card border-glow-green overflow-hidden">
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <CardTitle className="text-xl tracking-tight">{study.company}</CardTitle>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      <h4 className="font-medium text-sm text-muted-foreground mb-3">RESULTS</h4>
        ...
        <ScrollReveal>
          <div className="mx-auto max-w-4xl mb-16">
            <div className="text-center mb-12">
              <h3 className="text-2xl font-heading font-bold tracking-tighter mb-4">What Our Clients Say</h3>
            </div>
        ...
        <ScrollReveal>
          <div className="text-center">
            <Card className="glassmorphic-card max-w-2xl mx-auto">
              <CardHeader>
                <CardTitle className="text-2xl tracking-tight">Ready to Join These Success Stories?</CardTitle>
                <CardDescription className="text-base">
                  Start your digital transformation journey with our proven platform
                </CardDescription>
              </CardHeader>
              <CardContent>
