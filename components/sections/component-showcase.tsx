                      ...
                      <div className="p-6 glassmorphic-card">
                        <form className="space-y-4">
                          <div className="space-y-2">
                            ...
                            <input
                              className="flex h-10 w-full rounded-md border border-input bg-white/50 backdrop-blur-sm px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all focus-visible:scale-[1.01]"
                              id="email"
