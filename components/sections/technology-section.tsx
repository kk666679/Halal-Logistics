  ...
  const technologies = [
    {
      ...
      description:
        "Enterprise-grade blockchain infrastructure for immutable record keeping and smart contract execution.",
    ...
    },
    {
      ...
      description:
        "Advanced AI agents for certification validation, logistics optimization, and compliance monitoring.",
      features: [
        "Machine Learning",
    ...
    },
    {
      ...
      description:
        "Scalable cloud infrastructure with enterprise-grade security and global availability.",
    ...
    },
    {
      ...
      description:
        "Military-grade encryption and security protocols to protect sensitive Halal certification data.",
      features: [
        "256-bit Encryption",
    ...
    },
    {
      ...
      description:
        "High-performance real-time data processing for supply chain monitoring and alerts.",
      features: [
        "Sub-second Response",
        "Real-time Analytics",
        "Live Dashboards",
    ...
    },
    {
      ...
      description:
        "Seamless integration with international Halal certification bodies and regulatory systems.",
      features: [
        "API Integrations",
        "Global Standards",
  ...
  const architectureFeatures = [
    {
      ...
      description:
        "Modular design allowing independent scaling and deployment of different components",
      benefits: ["Scalability", "Fault Isolation", "Technology Diversity"],
    },
    {
      title: "Event-Driven Processing",
      description:
        "Real-time event processing for supply chain monitoring and automated responses",
      benefits: [
        "Real-time Updates",
        "Automated Workflows",
    ...
    },
    {
      ...
      description:
        "Comprehensive REST and GraphQL APIs for seamless third-party integrations",
      benefits: [
        "Easy Integration",
        "Developer Friendly",
        "Extensible Platform",
                ...
                <Card className="h-full glassmorphic-card group blockchain-glow">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <ProgressCard
                      ...
                      variant="minimal"
                      progressColor={
                        tech.performance >= 95 ? "bg-green-500" : "bg-primary"
                      }
                    />
                  </CardContent>
                </Card>
