  ...
  const blogPosts = [
    {
      ...
      description:
        "Learn how to create stunning user interfaces using our component library.",
      date: "May 15, 2023",
      readTime: "5 min read",
    },
    {
      ...
      description:
        "Discover how Tailwind CSS and React can transform your development workflow.",
      date: "April 28, 2023",
      readTime: "7 min read",
    },
    {
      ...
      description:
        "Best practices for creating accessible UI components for all users.",
      date: "April 10, 2023",
      readTime: "6 min read",
    },
  ];
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 opacity-70">
                Stay updated with our latest insights, tutorials, and best
                practices.
              </p>
            </div>
          </div>
