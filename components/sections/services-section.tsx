  ...
  const services = [
    {
      ...
      description:
        "End-to-end Halal certification tracking with blockchain verification and automated compliance monitoring.",
      features: [
    ...
    },
    {
      ...
      description:
        "Temperature-controlled supply chain management ensuring Halal compliance throughout transportation.",
      features: [
    ...
    },
    {
      ...
      description:
        "Comprehensive audit management with automated reporting and regulatory compliance tracking.",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete transparency across your entire supply chain with real-time tracking and analytics.",
      features: [
    ...
    },
    {
      ...
      description:
        "Secure collaboration platform for suppliers, certifiers, auditors, and government agencies.",
      features: [
        "Role-based access",
    ...
    },
    {
      ...
      description:
        "Support for international Halal standards including JAKIM, MUI, and other global certifications.",
      features: [
  ...
  const processSteps = [
    {
      ...
      description:
        "Register your products and upload documentation for certification review",
    },
    {
      step: "02",
      title: "AI-Powered Verification",
      description:
        "Our AI agents automatically verify compliance against Halal standards",
    },
    {
      step: "03",
    ...
    },
    {
      ...
      description:
        "Ongoing monitoring ensures sustained compliance throughout the supply chain",
    },
  ];
            ...
            <Card className="glassmorphic-card max-w-2xl mx-auto">
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  Join leading Halal businesses worldwide who trust our platform
