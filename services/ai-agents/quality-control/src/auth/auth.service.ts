...
export class AuthService {
    ...
    const mockUsers = [
      {
        ...
        permissions: ['read', 'write', 'admin', 'quality:inspect', 'quality:manage'],
      },
      {
        id: '2',
        username: 'inspector',
        ...
        roles: ['inspector'],
        permissions: ['read', 'write', 'quality:inspect'],
      },
      {
        id: '3',
        username: 'viewer',
  ...
  async getUserPermissions(userId: string): Promise<string[]> {
    ...
    const mockPermissions = {
      '1': ['read', 'write', 'admin', 'quality:inspect', 'quality:manage', 'quality:analyze'],
      '2': ['read', 'write', 'quality:inspect', 'quality:analyze'],
      '3': ['read'],
    };
  ...
  async getUserActivity(userId: string, limit: number = 10): Promise<any[]> {
    ...
    return [
      ...
      },
      {
        ...
        details: { inspectionId: 'inspection_1', productId: 'product_1' },
      },
      {
        id: 'activity_3',
        userId,
